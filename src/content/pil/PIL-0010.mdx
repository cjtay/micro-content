...
pubDate: 2025-06-20T10:42:03.454Z
draft: false
days: 28
treatments: [
    {
      ...
      "info": "to be taken once daily by mouth"
    }
  ]
treatmentSchedule: [
    {
...
commonSideEffects: [
  ...
  { name: "Diarrhoea" },
  {
    ...
    description: "usually seen during the first few weeks, if it continues, then notify your doctor"
  },
  { name: "Dizziness" },
  ...
  { name: "Muscle pain" },
  {
    ...
    description: "chest pain or tightness, irregular heartbeat or blood pressure changes, shortness of breath"
  }
]
