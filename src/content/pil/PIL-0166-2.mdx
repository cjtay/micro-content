...
pubDate: 2025-06-20T09:26:41.341Z
draft: false
days: 21
treatments: [
    {
...
commonSideEffects: [
  ...
  },
  {
    ...
    description: "Some medicines may accumulate in the bladder and cause damage to your bladder or urinary tract. If you feel pain while urinating, have problems passing urine or have blood in your urine with or without a fever, notify your doctor immediately."
  }
]
...
rareSideEffects: [
  ...
  { name: "Cardiac problems (irregular heartbeat, shortness of breath, chest discomfort)" },
  { name: "Risk of secondary cancer" },
  { name: "Allergic reactions" },
  { name: "Blurred vision" },
  { name: "Hearing loss" },
  { name: "Blood clots (Life-threatening)" },
...
# Doxorubicin and Cyclophosphamide (AC) Q21 Days
