...
pubDate: 2025-07-02T08:26:36.099Z
draft: false
days: 21
treatments: [
    {
...
otherCommonSideEffects: [
  ...
  { name: "Proteinuria (Monitored by urine dipstick test)" },
  { name: "Constipation" },
...
occasionalSideEffects: [
  ...
  { name: "Lung/breathing problems (cough, shortness of breath, flu like symptoms)" },
...
rareSideEffects: [
  ...
  { name: "Inflammation in different organs (e.g. thyroid, pituitary gland, liver, kidneys and pancreas)" },
  { name: "Adrenal gland dysfunction  (reduced cortisol level)" },
